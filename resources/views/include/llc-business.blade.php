<!--  Section LLC Ads Business -->
<section id="llc-business-main">
    <div class="llc-business-container">
        <header class="llc-business-wrapper">
            <h1 class="llc-business-heading">CREATE A BUSINESS</h1>
        </header>
        <div class="llc-img-container">
            ...
            <div class="temple-state-hover">
                <div class="temple-img-wrapper">
                    <img class="temple-img" src="/img/temple.png" alt="Temple">
                </div>
                <div class="state-img-wrapper">
                    <img class="state-img" src="/img/state.png" alt="State">
                </div>
    ...
    <div class="business-gradient-line"></div>
</section>
<!-- END -- Section LLC Ads Business -->