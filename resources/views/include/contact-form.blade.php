    ...
    <div class="contact-container-left">
        ...
        <div class="contact-wraper-left">
            ...
            <div class="contact-social-media">
                <a class="facebook-form-icon" href="https://www.facebook.com/deca23designs/?modal=admin_todo_tour"><i
        ...
        <div class="contact-wrapper-right">
            ...
            <form class="form-contact-container" action="">
                ...
                <div class="text-form-wrapper">
                    <textarea id="text-area-input" class="input-text" required name="text" placeholder="Message"
