            ...
            <div className="main main-website-section">
                ...
                <div className="mainContent">
                    ...
                    <div className="navigator-stucture">
                        <h2 className="structure-title">Content</h2>
                        <div className="line-content-page" />
                        <div className="content-example">
                            <div className="content-rectangle" />
                        </div>
                        <div className="bg-shape-blue-content" />
                    </div>
                </div>
            </div>
            <div id="footer">
                <div className="arrow-container">
                    ...
                    <Link className="arrow-text" to="/aside">
                        intra si vezi
                    </Link>
                </div>
                <NavWebsiteSection />
